...
function Step3report({ report }) {
  ...
  if (finalScore >= 8) {
    ...
    shortTagline = "Excellent clarity and stractured response.";
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-6 sm:px-6 lg:px-10 py-8">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="md:mb-10 w-full flex items-start gap-4">
          ...
          <div>
            <h1 className="text-3xl fornt-bold text-gray-800 flex-nowrap">
              ...
              {skills.map((s, i) => (
                <div key={i}>
                  ...
                  <div className="bg-gray-200 h-2 sm:h-3 rounded-full">
                    <div className="bg-green-200 h-2 sm:h-3 rounded-full">
                      <div
